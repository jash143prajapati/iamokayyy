...
if __name__ == '__main__':
    ...
    while (choice != 5):
        ...
        if (choice == 1):
            ...
            print("Student who plays both cricket and badminton :",
                  CriandBad(GroupACri, GroupBBad))

        elif (choice == 3):
            print("Student who plays cricket or badminton but not both :",
                  CriorBadnotboth(GroupACri, GroupBBad))

        elif (choice == 3):
            print("Number of student who plays neither cricket not badminton :",
                  onlyfootball(GroupCFoot, GroupACri, GroupBBad))

        elif (choice == 4):
            print("Number of student who plays cricket and football not badminton ",
                  CriandFootnotBad(GroupACri, GroupCFoot, GroupBBad))
        elif (choice == 5):
            break
        else:
            print("Invalid")
